  ...
  return (
    <div className='w-screen p-3 z-10 flex   top-0 fixed justify-between bg-white'>
        ...
        <ul  className='flex gap-4 text-[15px]' style={{fontFamily: 'Montserrat Alternates'}}>
            ...
            <li className='px-3 py-1  rounded-2xl hover:outline outline-1 outline-offset-2 '><Link to="/cart">Cart <span className=' p-1 rounded-full text-white text-xs px-2 bg-red-600'>{totalQuantity}</span></Link></li>
        </ul>
    </div>
  )
}
